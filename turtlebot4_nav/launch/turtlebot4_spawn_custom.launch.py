# Clone of turtlebot4_spawn.launch.py from turtlebot4_ignition_bringup package
...
def generate_launch_description():
    ...
    # (HB) Add turtlebot4_nav package (custom package) directory
    ...
    # (HB) Replace the paths for localization, slam, nav2
    localization_launch = PathJoinSubstitution(
        [pkg_turtlebot4_nav, 'launch', 'localization_custom.launch.py'])
    slam_launch = PathJoinSubstitution(
        [pkg_turtlebot4_nav, 'launch', 'slam_custom.launch.py'])
    nav2_launch = PathJoinSubstitution(
        [pkg_turtlebot4_nav, 'launch', 'nav2_custom.launch.py'])
