# Clone of ignition.launch.py from turtlebot4_ignition_bringup package
...
def generate_launch_description():
    ...
    pkg_ros_ign_gazebo = get_package_share_directory(
        'ros_ign_gazebo')
    # (HB) Add turtlebot4_nav package (custom package) directory (Though this package is not exclusively used in this code)
